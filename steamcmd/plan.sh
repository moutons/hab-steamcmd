...
pkg_name=steamcmd
pkg_origin=brosephus
pkg_version="0.1.0"
pkg_maintainer="Shaun Mouton <sdmouton@devops.christmas>"
pkg_license=('Apache-2.0')
pkg_source="https://steamcdn-a.akamaihd.net/client/installer/${pkg_name}_linux.tar.gz"
...
# pkg_shasum="c7e382f81d5a44036ebb21fd6aa77f68fb4ac0b6d6f4c209ef389b05eba0f9b8"
...
# pkg_deps=(core/glibc)
pkg_deps=(core/gcc-libs core/gcc)
...
# of your package.
pkg_description="Updates and runs Valve's SteamCMD."

# Required for core plans, optional otherwise.
# The project home page for the package.
pkg_upstream_url="https://developer.valvesoftware.com/wiki/SteamCMD"
